...
class CreateWritePreview(plugin.AbstractWriteRender):
    # change this to template preset
    name = "WritePreview"
    label = "Create Write Preview"
    hosts = ["nuke"]
    n_class = "Write"
    family = "render"
    icon = "sign-out"
    ...
    defaults = ["compositing_preview", "lighting_preview", "fx_preview"]
    prenodes = {
        "Reformat01": {
            "nodeclass": "Reformat",
            "dependent": None,
    ...
    def __init__(self, *args, **kwargs):
        super(CreateWritePreview, self).__init__(*args, **kwargs)
